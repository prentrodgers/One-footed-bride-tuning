# How Two Algorithms Transformed Bach Chorales: A Journey from Mathematical Chaos to Musical Harmony
...
2. **Emotional Impact:** The pure intervals create a more direct emotional connection. Major chords sound more joyful, minor chords more poignant. The music feels more "alive." The higher ratio intervals put the listener on edge, waiting for a resolution to the sweet sounding lower intervals. Think if it as the habenaro chili pepper added to an enchilada casserole.
...
[Include audio examples here: same chorale in 12-TET, SA-only, and SA+Viterbi]

Listen to the difference. The first version (12-TET) is what you'd hear on a piano. The second (SA-only) has better chords but some jarring jumps. The third (SA+Viterbi) combines the best of both worlds—pure chords that flow seamlessly.
...
*Technical details and code available at: [https:](https://github.com/prentrodgers/One-footed-bride-tuning)*

*Audio examples appear daily on my twitter feed at https://x.com/prentrodgers*