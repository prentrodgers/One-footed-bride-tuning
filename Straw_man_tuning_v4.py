...
def parse_args():
    ...
    parser.add_argument('--max_delta', type=int, default=35)
    parser.add_argument('--tolerance', type=int, default=1)
    # SA core (v3 style)
    parser.add_argument('--rolls', type=int, default=4)
    parser.add_argument('--sa_iters', type=int, default=20, help='SA iterations per chord per roll (default: 20)')
    ...
    # SA restarts (v3)
    parser.add_argument('--sa_restarts', type=int, default=1, help='Number of SA restarts per chord (default: 1)')
    parser.add_argument('--parallel_restarts', type=int, default=1, help='Run SA restarts in parallel (default: 1)')
    parser.add_argument('--restart_repeat_threshold', type=int, default=3, help='Early-stop restarts on canonical chord repetition (default: 3)')
